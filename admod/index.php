<?php
/**
 * Copyright (C) 2023 CyberDay Studios. All right reserved.
 */
...
<html lang="en">
    <head>
        <style>
            body{margin:0;color:white;}.navbar{overflow:hidden;background-color:#333;position:fixed;top:0;width:100%}.navbar a{float:left;display:block;color:#f2f2f2;text-align:center;padding:14px 16px;text-decoration:none;font-size:20px}.main{margin-top:120px}
        </style>
        ...
        <div class="w3-content" style="max-width: 100%;">
            <div class="navbar">
                <a href="../public/index.php" style="text-decoration: none;">
                    <img src="../public/images/banner_top.png" style="width:80%;">
                </a>
                <div style="margin-top: 28px;"></div>
                <button id="myBtn" class="w3-btn w3-black w3-border w3-border-red w3-round-large">
                    <svg fill="white" height="20px" width="20px" version="1.1" id="Capa_1" 
                    ...
                    viewBox="0 0 474.565 474.565" xml:space="preserve">
                        <g>
                            ...
                            <path d="M134.524,73.928c-43.825,0-63.997,55.471-28.963,83.37c11.943-31.89,35.718-54.788,
                            66.886-63.826
            ...
            <div id="myModal" class="modal">
                ...
                <div class="modal-header" style="border-radius: 20px 20px 0 0;">
                    <span style="display: flex; justify-content: center; align-items: center; background-color: #363535; width: 36px; height: 36px; position: relative; top: 12px;" class="close">&times;</span>
                    <div style="display: flex; align-items: center;">
                        <svg height="32px" id="Capa_1" fill="white"
                        style="enable-background:new 0 0 10 10;" version="1.1" 
                        viewBox="0 0 91.999 92" width="32px" xml:space="preserve"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <path d="M45.385,0.004C19.982,0.344-0.334,21.215,0.004,46.619c0.34,25.393,21.209,
                            45.715,46.611,45.377  c25.398-0.342,45.718-21.213,45.38-46.615C91.655,19.986,
                            70.785-0.335,45.385,0.004z M45.249,74l-0.254-0.004  c-3.912-0.116-6.67-2.998-6.559-6.852c0.109-3.788,
                            2.934-6.538,6.717-6.538l0.227,0.004c4.021,0.119,6.748,2.972,6.635,6.937  C51.903,
                            71.346,49.122,74,45.249,74z M61.704,41.341c-0.92,1.307-2.943,2.93-5.492,4.916l-2.807,
                            1.938  c-1.541,1.198-2.471,2.325-2.82,3.434c-0.275,0.873-0.41,1.104-0.434,2.88l-0.004,
                            0.451H39.429l0.031-0.907  c0.131-3.728,0.223-5.921,1.768-7.733c2.424-2.846,7.771-6.289,
                            7.998-6.435c0.766-0.577,1.412-1.234,1.893-1.936  c1.125-1.551,1.623-2.772,
                            1.623-3.972c0-1.665-0.494-3.205-1.471-4.576c-0.939-1.323-2.723-1.993-5.303-1.993  c-2.559,0-4.311,
                            0.812-5.359,2.478c-1.078,1.713-1.623,3.512-1.623,5.35v0.457H27.935l0.02-0.477  c0.285-6.769,
                            2.701-11.643,7.178-14.487C37.946,18.918,41.446,18,45.53,18c5.346,0,9.859,1.299,13.412,
                            3.861  c3.6,2.596,5.426,6.484,5.426,11.556C64.368,36.254,63.472,38.919,61.704,41.341z"/>
                            <g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/>
                        </svg>
                        <h3 style="padding-top: 3px; padding-left: 42.75%; display: flex; align-items: center;">
                            <b>Help (Beta)</b>
                        </h3>
                    </div>
                </div>

                <hr style="margin: 0; border: none; border-top: 1px solid #6e6e6e; width: 100%;">
                <!-- Modal content -->
                <div class="modal-body" style="max-height: 450px; overflow-y: auto; border-radius: 0 0 20px 20px; color: white;">
                    <div style="padding-top: 10px"></div>
                    <div class="w3-container" style="background-color: #0241a6; border-radius: 20px;">
                        <h6>
                            <svg fill="white" xmlns="http://www.w3.org/2000/svg"  viewBox="-20 -1 80 20" width="30px" height="30px">
                                <path d="M 25 2 C 12.309295 2 2 12.309295 2 25 C 2 37.690705 12.309295 48 25 48 C 37.690705 48 
                                48 37.690705 48 25 C 48 12.309295 37.690705 2 25 2 z M 25 4 C 36.609824 4 46 13.390176 46 25 
                                C 46 36.609824 36.609824 46 25 46 C 13.390176 46 4 36.609824 4 25 C 4 13.390176 13.390176 4 25 
                                4 z M 25 11 A 3 3 0 0 0 22 14 A 3 3 0 0 0 25 17 A 3 3 0 0 0 28 14 A 3 3 0 0 0 25 11 z M 21 21 
                                L 21 23 L 22 23 L 23 23 L 23 36 L 22 36 L 21 36 L 21 38 L 22 38 L 23 38 L 27 38 L 28 38 L 29 
                                38 L 29 36 L 28 36 L 27 36 L 27 21 L 26 21 L 22 21 L 21 21 z"/>
                            </svg>
                            <b style="padding: 2px; text-align: center;">
                                Help are currently in Beta: 
                            </b>
                            Something features and function of Help now currently work as basic state, but they may have some error
                            or glitches. <br><br>We are currently working on this features. The beta version 
                            may not reflect to final release.
                            <br><br>
                            If you found the error or glitches, please 
                    ...
                    <p>
                        If you see this button in the Navigation bar, 
                        you are operating this website in administration mode.
                    </p>

                    <div class="w3-container">
                        <!-- WARNING SECTION -->
                        <div style="border-radius: 20px;">
                            <svg fill="yellow" version="1.1" id="Capa_1" 
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                            width="32px" height="32px" viewBox="0 -1 34.854 34.855"
                            xml:space="preserve">
                                <g>
                                    <path d="M34.653,30.47L18.727,
                                    2.884c-0.269-0.464-0.764-0.75-1.299-0.75c-0.537,0-1.031,
                                    0.286-1.3,0.75L0.202,30.47c-0.269,0.464-0.269,1.036,0,
                                    1.5s0.763,0.75,1.299,0.75h31.853c0.535,0,1.031-0.286,1.3-0.75
                                    C34.921,31.506,34.921,30.934,34.653,30.47z M4.099,29.72L17.427,
                                    6.634L30.756,29.72H4.099z M15.427,11.677h4V23.51h-4V11.677z
                                    M15.427,25.507h4v2.919h-4V25.507z"/>
                                </g>
                            </svg>
                            <p style="color: yellow;">
                                <div style="margin-top: 1.5%;"></div>
                                    <strong style="color: yellow;">IMPORTANT NOTIFICATION:</strong> 
                                    <b style="color: yellow;">
                                        <br><br>
                                        Changes you make will be effective immediately and permanently on this site, 
                                        unless expressly revised. In the worst case, you will partially or completely 
                                        crash the site, lose administrative access, and it will freeze the entire site. 
                                        Be careful!
                                    </b>
                                </div>
                            </p>
                        ...
                        <div class="faq-title">
                            <!-- <button onclick="show_hide()">
                                PLACE HOLDER BUTTON HERE
                            </button> -->
                            <hr style="border: none; border-top: 1px solid #6e6e6e;">
                            <h6>
                                <b>
                                    Who can use or access to Administration mode?
                                    Normal user can register account to access to Administration mode?
                                </b>
                            </h6>

                            <div class="faq-content">
                                <p>
                                    Please note that Administration mode can be used only by Administrators and moderators.
                                    <br><br>
    
                                    To access Administration mode, you must provide username and password that specially
                                    provided to you. Then, you must to complete all of authentication and verification, 
                                    which designed to identity you and ensure only administrators and moderators can 
                                    be accessed to Administration mode.
                                </p>
                            </div>
                        </div>
                        <p>
                            If you try authenticate many times but login attempt failed,
                            your IP address will be recorded and a warning message box will
                            show.
                        </p>
                        <p>
                            If you forget your password, please contact to 
                            <a href="mailto:thanhdz167@gmail.com"> administrator</a> 
                            to recover your password.
                        </p>
                        <p>
                            If you want to become administrator or moderator, we always welcome. Just 
                            <a href="mailto:thanhdz167@gmail.com"> contact us</a> to
                            be considered to administrator or moderator.
                        </p>
                    </div>
                    <!-- END -->
                </div>
            ...
            <div class="w3-col l8 s12">
                <div class="w3-margin">
                    ...
                    <div class="w3-container w3-yellow">
                        <p>
                            <div style="margin-top: 1.5%;"></div>
                            <svg fill="black" version="1.1" id="Capa_1" 
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                                width="16px" height="16px" viewBox="0 -1 34.854 34.855"
                                xml:space="preserve">
                                    <g>
                                        <path d="M34.653,30.47L18.727,
                                        2.884c-0.269-0.464-0.764-0.75-1.299-0.75c-0.537,0-1.031,
                            ...
                            You're running in Administration mode.
                            <b>
                                Please very carefully on your actions!
                            </b>
                        </p>
                    </div>
                    <div style="margin-top: 2.25%;"></div>
                    <div class="w3-container w3-red">
                        <p>
                            <svg fill="white" version="1.1" id="Capa_1" 
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                            width="18px" height="18px" viewBox="0 -1 34.854 34.855"
                            xml:space="preserve">
                                <g>
                                    <path d="M34.653,30.47L18.727,
                                    2.884c-0.269-0.464-0.764-0.75-1.299-0.75c-0.537,0-1.031,
                            ...
                            <b>WARNING: </b> 
                            This page only for administrators and moderators. 
                            Please do not enter this page unless you are administrators or moderators.
                        </p>
                    </div>
                    <!-- END MESSAGE -->
                    ...
                    style="background-color: transparent; border-radius: 10px;">
                        ...
                        <label class="w3-text-black" style="font-size: 18px;">
                            <b>Username</b>
                        </label>
                        <div style="padding-top: 5px;"></div>
                        <input class="w3-input w3-border w3-round-large" type="text" 
                            placeholder="Enter your administrator/moderator username"
                            style="background-color: #c5c5c5; border-radius: 10px;">
                        ...
                        <div style="padding-top: 5px;"></div>
                        <input class="w3-input w3-border w3-round-large" type="text" 
                            placeholder="Enter your administrator/moderator password"
                            style="background-color: #c5c5c5; border-radius: 10px;">
                    </form>
                </div>
            </div>
            ...
            <div class="w3-col l4">
                ...
                <div class="w3-card w3-margin w3-margin-top">
                    ...
                    <div class="w3-container w3-white">
                        ...
                        <p>
                            CyberBlog will become the place where we document everything about our projects, tips, 
                            tricks, and stories as we develop a project. 
                        </p>
                        <p>
                            Stay tuned for the latest tips, tricks,
                            and notes that will make your life easier and don't forget to read our stories, 
                            you might find more tips, technical perspectives and other interesting things!
                        </p>
                    </div>
                </div>
                <hr>
